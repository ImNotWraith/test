...
class Window(QMainWindow):
    ...
    def initUI(self):
        ...
        scroll.setStyleSheet("QScrollArea { background: transparent; border: none; } QScrollBar:vertical { background: #151515; width: 6px; border-radius: 3px; } QScrollBar::handle:vertical { background: #3c3c3c; border-radius: 3px; }")
